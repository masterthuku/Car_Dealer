...
CREATE TABLE "DealershipInfo" (
    ...
    "address" TEXT NOT NULL DEFAULT '47 Ngong Road, Auto Plaza, Nairobi, Kenya',
    "phone" TEXT NOT NULL DEFAULT '+254 743 508 676',
    "email" TEXT NOT NULL DEFAULT 'vehiql@gmail.com',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
