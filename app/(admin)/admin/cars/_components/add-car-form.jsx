...
const AddCarForm = () => {
  ...
  const onMultiImagesDrop = (acceptedFiles) => {
    const validFiles = acceptedFiles.filter((file) => {
      if (file.size > 5 * 1024 * 1024) {
        toast.error(`${file.name} exceeds 5MB size limit and was skipped`);
        return false;
      }
      return true;
    });
        ...
        <TabsContent value="ai" className="mt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Upload an image to extract car details
              </CardDescription>
            </CardHeader>
            <CardContent>
