            ...
            <div className="p-4 border-t sm:border-t-0 sm:border-l sm:w-1/4 sm:flex sm:flex-col sm:justify-center sm:items-center sm:space-y-2">
              {booking.notes && (
                <div className="bg-gray-50 p-2 rounded text-sm w-full">
                  ...
                  <p className="text-gray-600">{booking.notes || "N/A"}</p>
                </div>
              )}
              <Button
                variant="outline"
              ...
              >
                ...
                >
                  View Car <ArrowRight className="h-4 w-4 ml-2" />
                </Link>
              </Button>
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              {booking.car.year} {booking.car.make} {booking.car.model} on{" "}
              {format(new Date(booking.bookingDate), "EEEE, MMMM d, yyyy")} from{" "}
              {formatTime(booking.startTime)} to {formatTime(booking.endTime)}? This action cannot be undone.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
